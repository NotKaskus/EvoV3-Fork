...
autofiring:addslider({ content = "Delay (milliseconds)", max = 1000, default = 60, flag = "autofiredelay", callback = function(value)
    aimbotgroup:Set('TriggerBot', 'Delay', value)
end })
autofiring:addslider({ content = "CPS", max = 50, min = 0, default = 10, flag = "autofirecps", callback = function(value)
